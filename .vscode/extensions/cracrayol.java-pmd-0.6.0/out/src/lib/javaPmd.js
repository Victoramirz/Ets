...
class JavaPmd {
    ...
    hasAtLeastOneValidRuleset() {
        ...
        vscode.window.showErrorMessage(`No valid Ruleset paths found in "javaPMD.rulesets". Ensure configuration correct or change back to the default.`);
        return false;
    }
...
exports.JavaPmd = JavaPmd;
//# sourceMappingURL=javaPmd.js.map